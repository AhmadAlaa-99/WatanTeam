...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">المستند</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                    تعديل محتوى المستند</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <select name="user_id" class="form-control SlectBox" onclick="console.log($(this).val())"
                                    onchange="console.log('change is firing')">
                                    <!--placeholder-->
                                    <option value="" selected disabled>حدد صاحب العلاقة</option>
