...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">البرامج</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/قائمة البرامج غير المفعلة</span>
						</div>
					</div>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu tx-13">
                                                        <a class="dropdown-item"
															...
															<a class="dropdown-item"  href="{{route('ActPro',$program->id)}}">
																تفعيل
																البرنامج</a>     
