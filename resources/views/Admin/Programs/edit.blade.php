                        ...
                        <div class="row">
							...
							<div class="col">
                                ...
                                <input type="text" class="form-control" id="inputName" name="audince"
                                    title="يرجي ادخال الرؤية  "value="{{$program->audince}}" required>
                            </div>
							<div class="col">
