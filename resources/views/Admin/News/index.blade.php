...
<div class="row">
            ...
            <div class="card-header pb-0">
                <div class="d-flex justify-content-between">
                        <a class="modal-effect btn btn-outline-primary btn-block" data-effect="effect-scale"
                            data-toggle="modal" href="#modaldemo8">اضافة خبر</a>
                </div>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <a class="dropdown-item" data-effect="effect-scale"
                                                            data-toggle="modal" href="#exampleModal2">تعديل</a>

															<a class="dropdown-item"  href="#" data-new_id="{{ $new->id }}"
                                                            data-toggle="modal" data-target="#delete_new"><i
    ...
    <div class="modal" id="modaldemo8">
        <div class="modal-dialog" role="new">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">اضافة خير</h6><button aria-label="Close" class="close" data-dismiss="modal"
    ...
    <div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="new">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('updatenews',$new->id) }}" method="post" autocomplete="off">
                        {{ method_field('patch') }}
                        {{ csrf_field() }}
                        
                        <div class="form-group">
                            <label for="message-text" class="col-form-label">تفاصيل الخبر:</label>
    ...
    <!-- delete -->
    <div class="modal" id="delete_new">
        <div class="modal-dialog modal-dialog-centered" role="new">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
