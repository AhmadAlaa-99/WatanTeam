...
@endsection
@section('title')
فريق وطن -  قسم الدورات التدريبية
@stop
@section('page-header')
				<!-- breadcrumb -->
                            ...
                            <div class="table-responsive">
                                <table id="example1" class="table key-buttons text-md-nowrap">
                                    <thead>
                                        <tr>
												...
												<th class="border-bottom-0">coache</th>
                                ...
                                @forelse ($courses as $course)
                                    ...
                                    <tr>
                                        <td>{{ $i }}</td>
                                        <td>{{ $course->desc }} </td>
                                        <td>{{ $course->types->name }}</td>
                                        <td>'test'</td>
										<td>
                                        <img class="img-responsive" src="{{asset('storage/Courses/'.$course->imageUrl)}}"width="100"height="100">
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu tx-13">
                                                    ...
                                                    href="{{ url('dashboard/courses/'.$course->id.'/edit')}}">تعديل
                                                            
                                                            الدورة</a>		  

															<a class="dropdown-item"  href="#" data-course_id="{{ $course->id }}"
                                                            data-toggle="modal" data-target="#delete_course"><i
