...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">الشركاء</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/قائمة الشركاء </span>
						</div>
					</div>
							...
							<div class="card-body">
                                ...
                                @forelse ($partners as $partner)
                                    ...
                                    <tr>
                                        ...
                                        <td><a  href="{{ route('PaDetails',$partner->id) }}">{{ $partner->name }} </td>
                                        <td>{{ $partner->desc }}</td>
                                        <td>{{ $partner->email }}</td>
                                        <td>{{ $partner->phone }}</td>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu tx-13">
                                                            ...
                                                            data-toggle="modal" data-target="#delete_partner"><i
                                                                class="text-danger fas fa-trash-alt"></i>الغاء الشراكة</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"> الغاء الشراكة </h5>
                ...
                <div class="modal-body">
                    هل انت متاكد من عملية الغاء الشراكة ؟
					{{ $partner->id }}
