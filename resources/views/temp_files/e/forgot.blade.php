					...
					<div class="login d-flex align-items-center py-2">
						...
						<div class="container p-0">
							<div class="row">
								...
								<div class="mb-5 d-flex"> <a href="{{ url('/' . $page='index') }}"><img src="{{URL::asset('assets/TeamLogo.jpg')}}" class="sign-favicon ht-40" alt="logo"></a><h1 class="main-logo1 ml-1 mr-0 my-auto tx-28">Va<span>le</span>x</h1></div>
